...
class Offers{
    #db=new DB();
    addOffer(user_id, products_id, product_name, product_cost_cash, product_cost_crypto, product_quantity, product_destcription, photo_id, photo_id, added_when, popularity){
        const query = `
